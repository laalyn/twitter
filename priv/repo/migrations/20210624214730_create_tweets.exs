defmodule Twitter.Repo.Migrations.CreateTweets do
  ...
  def change do
    create table(:tweets, primary_key: false) do
      ...
      add :retweeted_tweet_id, references(:tweets, [type: :binary_id, on_delete: :delete_all, on_update: :update_all])
      add :quoted_tweet_id, references(:tweets, [type: :binary_id, on_delete: :delete_all, on_update: :update_all])
      add :place_id, references(:places, [type: :binary_id, on_delete: :delete_all, on_update: :update_all])
